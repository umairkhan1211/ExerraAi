...
const LeftSection = () => {
  return (
    <div className="flex flex-col items-center justify-center p-8 text-white text-center max-w-full">
      ...
      <button className="bg-gradient-to-l from-[#F47321] to-[#65235C] border-2 border-white text-white px-4 py-2 sm:px-6 sm:py-3 rounded-lg text-sm sm:text-base md:text-lg font-semibold hover:bg-[#f26a1e] transition duration-300 animate-fade-in-delay-200">
        appointment.exerra.ai
      </button>
    </div>
  );
