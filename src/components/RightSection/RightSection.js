  ...
  return (
    <div className="flex flex-col items-center justify-center p-8 text-white text-center max-w-full ">
      ...
      <p className="text-lg mb-8 animate-fade-in-delay-100 text-justify max-sm:text-justify  max-sm:text-sm ">
        ...
        automations deploy in 5-10 days, requiring zero technical skills 
        .Free audits available to identify workflow.
      </p>
      <button className="bg-gradient-to-r  from-[#24145D]  to-[#C95EEA] border-2 border-white text-white px-6 py-3 max-sm:text-sm max-md:px-6 max-md:py-3 max-sm:px-1 max-sm:py-2 rounded-lg text-lg font-semibold hover:bg-[#832c67] transition duration-300 animate-fade-in-delay-200">
        automation.exerra.ai
      </button>
    </div>
  );
